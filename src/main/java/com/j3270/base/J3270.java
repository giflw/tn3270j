...
public final class J3270 implements Cloneable, Closeable {
     ...
     *
     * @throws J3270Exception if the underling {@code s3270} process fails to start
     */
     ...
     * Connect action.
     *
     * @param host Hostname information
     ...
     *
     * @param command   shell command to be executed
     * @param arguments arguments to the shell command
     * @return the command's output
     * @throws IllegalStateException if the {@link Safety} mode is not set to {@link Safety#UNSAFE}
     * @throws J3270Exception        if the action fails for any reason
     * @see <a href="http://x3270.bgp.nu/Unix/s3270-man.html#Actions">Actions</a>
     ...
     *
     * @param action action string to be executed
     ...
     *
     * @param blocking the new {@link Timeout} for blocking actions
     */
    ...
    /**
     * @param blocking the {@link Timeout} for blocking actions
     ...
     *
     * @param nonBlocking the new {@link Timeout} for non-blocking actions
     */
    ...
    /**
     * @param nonBlocking the {@link Timeout} for non-blocking actions
    ...
    /**
     * @param timeout the {@link Timeout} for both blocking and non-blocking actions
     ...
     *
     * @param safety the new {@link Safety} mode
     */
    ...
    /**
     * @param safety the {@link Safety} mode

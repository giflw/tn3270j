...
public final class ProcessPiper implements Closeable, Piper {
     ...
     *
     * @param command argument given to {@link Runtime#exec(String)} returned by the result of {@link Runtime#getRuntime()}
     ...
     *
     * @param builder {@link ProcessBuilder} used to {@link ProcessBuilder#start()} the {@link Process}
     ...
     *
     * @param process {@link Process} to be used by this instance
     */
